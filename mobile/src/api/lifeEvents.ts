...
export interface LifeEvent {
  ...
  eventDate: string; eventType: string; isRecurring: boolean; remindDaysBefore: number;
  note: string | null; createdAt: string; nextOccurrence?: string;
...
export interface CreateLifeEventData {
  ...
  personId?: string; isRecurring?: boolean; remindDaysBefore?: number; note?: string
}
