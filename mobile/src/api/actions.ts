...
export interface ActionItem {
  id: string; userId: string; threadId: string; personaId: string | null;
  content: string; dimension: string | null; status: string; dueDate: string | null;
  createdAt: string; thoughtTitle: string; thoughtId: string | null; personaName: string | null
}
