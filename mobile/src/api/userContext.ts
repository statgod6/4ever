...
export interface UserContext {
  id?: string; name?: string; age?: string; location?: string; role?: string;
  background?: string; currentProjects?: string; goals?: string;
  situation?: string; values?: string; pendingDecisions?: string; freeformContext?: string
}
