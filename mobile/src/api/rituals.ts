...
export interface Ritual {
  ...
  frequency: string; dayOfWeek: number | null; lastDoneAt: string | null;
  streak: number; isActive: boolean; createdAt: string; updatedAt: string;
  isOverdue?: boolean; nextDue?: string | null;
  person?: { id: string; name: string; relationship: string } | null
}

export interface CreateRitualData {
  title: string; frequency: string; personId?: string; dayOfWeek?: number
}
